...
class Medicament(models.Model):
    ...
    category = models.IntegerField(verbose_name='Категория', choices=CATEGORIES, default=CATEGORY_EMPTY_KEY)
    expiration_date = models.DateField(verbose_name='Годен до', blank=True, null=True)
    status = models.IntegerField(verbose_name='Статус', choices=STATUSES, default=STATUS_ACTIVE_KEY, blank=True, null=True)
