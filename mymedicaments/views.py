...
def get_medicaments(request):
    ...
    data = {'data': [
        [
            ...
            item.price,
            item.category.name,
            base_url + item.photo_face_small.url if item.photo_face_small.name else None,
            base_url + item.photo_date_small.url if item.photo_date_small.name else None,
            base_url + item.photo_recipe_small.url if item.photo_recipe_small.name else None,
...
def get_medicament_data(request, medicament_id):
    ...
    data = {
        ...
        'photo_face': base_url + medicament_data.photo_face_medium.url if medicament_data.photo_face_medium.name else None,
        'photo_date': base_url + medicament_data.photo_date_medium.url if medicament_data.photo_date_medium.name else None,
        'photo_recipe': base_url + medicament_data.photo_recipe_medium.url if medicament_data.photo_recipe_medium.name else None,
